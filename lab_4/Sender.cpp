...
int main(int argc, char** argv)
{
    ...
    if (out.is_open()) 
    {
        HANDLE ReadyEvent = OpenEvent(EVENT_MODIFY_STATE, 0, nameOfEvent.c_str());
        ...
        HANDLE senderSemaphore = OpenSemaphore(SEMAPHORE_MODIFY_STATE,0, "MESSAGES_COUNT_SEM");
        HANDLE mesReadEvent = OpenEvent(EVENT_ALL_ACCESS, 0, "MESSAGE_READ");
        ...
        while (true) 
        {
            ...
            if (false == std::cin.eof()) {
                ...
                {
                    std::cout << "Message file full. Waiting for receiver.\n";
